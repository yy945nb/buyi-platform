package com.buyi.common.redis.cache;

import com.alibaba.fastjson.JSON;
import com.buyi.common.redis.constant.RedisConstants;
import com.buyi.common.redis.exception.RedisCacheAccessException;
...
public class RedisDictionaryCache<K, V> implements DictionaryCache<K, V> {
    ...
    public RedisDictionaryCache(
        ...
        this.dataMap = redissonClient.getMap(dictionaryName + RedisConstants.DICT_CACHE_NAME_SUFFIX);
