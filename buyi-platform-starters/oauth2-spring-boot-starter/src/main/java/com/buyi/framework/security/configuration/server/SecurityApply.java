...
import com.buyi.framework.security.configuration.server.handler.*;
import com.buyi.framework.security.configuration.server.support.CustomGrantAuthenticationConverter;
import com.buyi.framework.security.configuration.server.support.CustomGrantAuthenticationProvider;
import com.buyi.framework.security.configuration.server.support.device.DeviceClientAuthenticationConverter;
import com.buyi.framework.security.configuration.server.support.device.DeviceClientAuthenticationProvider;
