...
import static com.buyi.framework.security.configuration.SecurityExtProperties.PLUGIN_PREFIX;
...
public class SecurityExtProperties {
     ...
     * 默认的过滤地址
     */
    private List<String> defaultIgnoreUrls = List.of("/getCaptcha", "/captcha", "/sms_captcha", "/message/**", "/favicon.ico", "/swagger-ui.html", "/doc.html", "/v3/api-docs/**", "/assets/**",
            "/css/**", "/webjars/**", "/login", "/error", "/oauth2/**");
