...
package com.buyi.framework.i18n.aspect;

import cn.hutool.core.util.ReflectUtil;
import cn.hutool.core.util.StrUtil;
import com.buyi.framework.commons.i18n.Language;
import com.buyi.framework.i18n.annotation.I18nField;
import com.buyi.framework.i18n.core.I18nMessageResource;
...
public class I18nAspect {
     ...
     * execution(public * com.buyi.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     * annotation(com.buyi.framework.commons.annotation.log.AccessLog) 解释：
     * 标记了@AccessLog 注解的方法
     */
    @Pointcut("execution(public * com.buyi..*.*(..)) && @annotation(com.buyi.framework.i18n.annotation.I18nMethod)")
