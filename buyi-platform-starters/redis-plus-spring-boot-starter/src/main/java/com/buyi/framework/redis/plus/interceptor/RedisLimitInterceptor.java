...
package com.buyi.framework.redis.plus.interceptor;

import com.buyi.framework.redis.plus.RedisLimitHelper;
import com.buyi.framework.redis.plus.anontation.RedisLimit;
import com.buyi.framework.redis.plus.utils.RedisAopUtils;
...
public class RedisLimitInterceptor {
    ...
    @Pointcut("@annotation(com.buyi.framework.redis.plus.anontation.RedisLimit)")
