...
import com.buyi.framework.redis.plus.RedisKeyGenerator;
import com.buyi.framework.redis.plus.anontation.RedisLock;
...
public class RedisLockInterceptor {
    ...
    @SneakyThrows
    @Around("execution(public * *(..)) && @annotation(com.buyi.framework.redis.plus.anontation.RedisLock)")
