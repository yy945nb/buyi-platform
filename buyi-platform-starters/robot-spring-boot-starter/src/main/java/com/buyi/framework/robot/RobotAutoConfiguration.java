...
package com.buyi.framework.robot;

import com.buyi.framework.robot.handler.DefaultIErrorMessageHandler;
import com.buyi.framework.robot.handler.IErrorMessageHandler;
import com.buyi.framework.robot.message.exception.DefaultRobotExceptionMessage;
import com.buyi.framework.robot.message.exception.IRobotExceptionMessage;
import com.buyi.framework.robot.message.exception.RobotExceptionNotifyAspect;
import com.buyi.framework.robot.message.push.DingTalkRobotMessageHandler;
import com.buyi.framework.robot.message.push.FeiShuRobotMessageHandler;
import com.buyi.framework.robot.message.push.RobotMessageHandler;
import com.buyi.framework.robot.message.push.WeChatRobotMessageHandler;
