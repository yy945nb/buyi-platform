...
package com.buyi.framework.boot.log.configuration;
...
import com.buyi.framework.boot.log.AccessLogProperties;
import com.buyi.framework.boot.log.AccessLogUtil;
import com.buyi.framework.boot.log.event.AccessLogEvent;
import com.buyi.framework.boot.log.handler.AbstractLogHandler;
import com.buyi.framework.commons.RegionUtils;
import com.buyi.framework.commons.annotation.log.AccessLog;
...
import com.buyi.framework.db.properties.MultiTenantType;
...
public class AccessLogAspect {
     ...
     * 切面
     */
    @Pointcut("execution(public * com.buyi..*.*(..)) && @annotation(com.buyi.framework.commons.annotation.log.AccessLog)")
